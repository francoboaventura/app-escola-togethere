...
const APP_VERSAO = '2026.07.31 · b127 (Supabase)';   // aparece no rodapé; mude a cada publicação no GitHub
...
const MERGE_COLS=['usuarios','turmas','alunos','presencas','material','temas','testes','contatos','planos','comentarios','atas','tarefas','relatorios','vipAlunos','pacotesVip','aulasVip','boletins','eventos','comunicados','planejamento','recessos','alertas','apoios','contratos','writings','formacao','formacaoReg','formacaoSessoes'];
